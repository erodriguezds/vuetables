...
| attr | object | null | no | An object of HTML attributes you wish to add to the action button.<br>The keys of this attributes object can be camelCased, and the value to the key can be of any type, even a function, in which case this function will be called with one parameter: your data object for the row that is being rendered.
